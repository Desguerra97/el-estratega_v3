...
(function () {
  ...
  function getTotalBest() {
    ...
    try {
      const email = student && student.email ? encodeURIComponent(student.email.toLowerCase().trim()).replace(/%/g,'_') : 'anonimo';
      const b = JSON.parse(localStorage.getItem('cun_lab_best_' + email) || '{}');
