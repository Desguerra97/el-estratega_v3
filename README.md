...
## Actualización v10 — estilo aventura y rompecabezas

- Personaje 2D ilustrado para El Estratega, reemplazando la bolita amarilla.
- Dementores y serpientes 2D dentro de jaulas; cada jaula está vinculada a una trampa.
- Al pisar una trampa se libera el enemigo correspondiente.
- Zona inicial físicamente cerrada, sin enemigos, cofres ni trampas, con una única salida.
- Desde el nivel 1 hay rocas empujables y cofres con preguntas que entregan pistas.
- Cada nivel tiene un único acertijo final: responder correctamente abre la puerta.
- Se eliminan las lecturas y la evaluación abierta/IA durante los niveles.
- La evaluación abierta/IA queda reservada para después del nivel 9.
- Las preguntas del recorrido se basan en el banco de 50 preguntas de Administración Estratégica – Semana 1.
